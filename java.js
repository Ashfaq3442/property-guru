...
(function() {
    ...
    function Bt(e, t) {
        ...
        if (a != null) {
            var o = [], c = !0, l = !1, v, h;
            try {
                for (a = a.call(e); !(c = (v = a.next()).done) && (o.push(v.value),
                !(t && o.length === t)); c = !0)
                    ;
            } catch (s) {
                l = !0,
    ...
    function Pe(e, t) {
        ...
        function s(p) {
            ...
            a; )
                try {
                    if (o = 1,
                    c && (l = p[0] & 2 ? c.return : p[0] ? c.throw || ((l = c.return) && l.call(c),
                    0) : c.next) && !(l = l.call(c, p[1])).done)
                        return l;
                    switch (c = 0,
                    l && (p = [p[0] & 2, l.value]),
                    p[0]) {
    ...
    var St = function(e) {
        var t, a, o = window.innerWidth < 400, c = e.state === Ce.FailureFeedback || e.state === Ce.FailureHavingTroubles, l, v = L(Mr, (l = (t = e.displayLanguage) === null || t === void 0 ? void 0 : t.toLowerCase()) !== null && l !== void 0 ? l : "nonexistent"), h, s = L(Lr, (h = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && h !== void 0 ? h : "nonexistent");
        return o ? Fr({
    ...
    function pr() {
        ...
        var o = t.split("?");
        return o.length > 1 && (a.params = new URLSearchParams(o[1])),
        a
    }
    function W() {
    ...
    var It = function(e, t, a) {
        var o = Tt(t.params, !1), c = "h/".concat("g", "/"), l, v, h = "".concat(o, "/cdn-cgi/challenge-platform/").concat(c, "feedback-reports/").concat(Xe(e), "/").concat(t.displayLanguage, "/").concat((v = t.params.theme) !== null && v !== void 0 ? v : t.theme, "/").concat(a);
    ...
    function mr(e) {
        ...
        var t = function(a, o) {
            if (!a || a.tagName === "BODY")
                return o;
            for (var c = 1, l = a.previousElementSibling; l; )
                l.tagName === a.tagName && c++,
    ...
    function yr(e) {
        if (typeof e != "string")
            throw new Error("djb2: expected string, got ".concat(typeof e == "undefined" ? "undefined" : F(e)));
    ...
    function hr(e, t) {
        ...
        if (!(!o || !o.parentNode)) {
            ...
            v.src = l.toString(),
            o == null || (a = o.parentNode) === null || a === void 0 || a.replaceChild(v, o)
        }
    }
    function _r(e, t) {
        var a = e._pState;
        return a ? (t.isReady = a.isReady,
    ...
    function Wr(e) {
        ...
        try {
            for (var c = e.widgetMap[Symbol.iterator](), l; !(t = (l = c.next()).done); t = !0) {
                var v = Ie(l.value, 2), h = v[0], s = v[1], p;
                s.watchcat.seq = e.watchCatSeq,
                s.watchcat.lastAckedSeq === 0 && (s.watchcat.lastAckedSeq = e.watchCatSeq);
                var _ = $(h);
                if (!_ || !s.shadow) {
                    s.watchcat.missingWidgetWarning || (x("Cannot find Widget ".concat(_, ", consider using turnstile.remove() to clean up a widget.")),
    ...
    function Ft() {
        var e = [er, tr];
        y.isRecaptchaCompatibilityMode && e.push(rr),
    ...
    function Ur(e) {
        ...
        if (!(t === void 0 || t.hasResponseParamEl)) {
            ...
            if (o) {
                ...
                c.type = "hidden";
                var l;
                c.name = (l = t.params["response-field-name"]) !== null && l !== void 0 ? l : xt,
    ...
    function Tr(e, t) {
        ...
        if (o !== null && V(o, HTMLInputElement) && (o.value = t),
    ...
    var Dt = function() {
        var e = function(n, i, r, u) {
          ...
          , t = function(n, i, r) {
            if (n.params.retry === ve.Auto || r) {
                n.isExecuted && (n.msgQueue.push(ue.Execute),
                n.isExecuted = !0,
                n.isExecuting = !0);
          ...
          , a = function(n, i, r) {
            var u;
            n.response === void 0 && g("[Internal Error] Widget was completed but no response was given", 1362),
            n.isExecuting = !1,
            n.isComplete = !0,
            Tr(i, n.response),
            (u = n.cbSuccess) === null || u === void 0 || u.call(n, n.response, r)
        }
          , o = function(n) {
            if (!n)
                return [];
            for (var i = n.attributes, r = i.length, u = new Array(r), d = 0; d < r; d++)
                u[d] = i[d].name;
            return u
        }
          , c = function(n, i, r) {
          ...
          , s = function(n, i) {
            if (i) {
                ...
                u.length > 0 && g("The parameters ".concat(r.join(","), " is/are not allowed be changed between the calls of render() and execute() of a widget.\n    Consider rendering a new widget if you want to change the following parameters ").concat(u.join(",")), 3618),
                i.action && (dt(i.action) || g('Invalid input for optional parameter "action", got "'.concat(i.action, '"'), 3604),
                n.action = i.action),
                i.cData && (ft(i.cData) || g('Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'), 3605),
                n.cData = i.cData),
                i["after-interactive-callback"] && (n.cbAfterInteractive = i["after-interactive-callback"]),
                i["before-interactive-callback"] && (n.cbBeforeInteractive = i["before-interactive-callback"]),
                i.callback && (n.cbSuccess = i.callback),
                i["expired-callback"] && (n.cbExpired = i["expired-callback"]),
                i["timeout-callback"] && (n.cbTimeout = i["timeout-callback"]),
                i["error-callback"] && (n.cbError = i["error-callback"]),
                i["unsupported-callback"] && (n.cbUnsupported = i["unsupported-callback"]),
                i.chlPageData && (n.chlPageData = i.chlPageData)
            }
        }
          , p = function(n) {
            _(z.Api, n)
          ...
          , _ = function(n, i) {
            ...
            if (u) {
                ...
                u.watchcat.seq = 0,
                u.params.execution === me.Render && (u.msgQueue.push(ue.Execute),
                u.isExecuted = !0,
                u.isExecuting = !0);
                var m = $(r)
                  , w = u.shadow.querySelector("#".concat(m));
                (!m || !w) && g("Widget ".concat(r, " to reset was not found."), 3330),
                u.params.appearance === Q.InteractionOnly && xr(w),
                u.params.sitekey === null && g("Unexpected Error: Sitekey is null", 3347);
                var E = w.cloneNode(), S;
                E.src = Rt(r, u.params.sitekey, u.params, (S = u.rcV) !== null && S !== void 0 ? S : K, !1, "g", n, _t(u)),
                (d = w.parentNode) === null || d === void 0 || d.replaceChild(E, w),
                Nt(m),
                u.retryTimeout && window.clearTimeout(u.retryTimeout)
            } else
                g("Widget ".concat(r, " to reset was not found."), 3331)
        }
          , A = function(n) {
            var i, r = R(n);
          ...
          , T = function(n, i) {
            ...
            if (typeof n == "string")
                try {
                    ...
                    w || g('Unable to find a container for "'.concat(n, '"'), 3585),
                    m = w
                } catch (jt) {
                    g('Invalid type for "container", expected "selector" or an implementation of "HTMLElement", got "'.concat(n, '"'), 3586)
                }
            else
                V(n, HTMLElement) ? m = n : g('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            var E = !0
              , S = !1
              , I = void 0;
            try {
                for (var D = y.widgetMap.values()[Symbol.iterator](), U; !(E = (U = D.next()).done); E = !0) {
                    var X = U.value;
            ...
            var J = qr(m);
            if (J) {
                var f = Object.assign(J, i), he = f.action, re = f.cData, ke = f.chlPageData, j = f.sitekey, ae;
                ...
                typeof j != "string" && g('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof j == "undefined" ? "undefined" : F(j), '"'), 3588),
                Kt(j) || g('Invalid input for parameter "sitekey", got "'.concat(j, '"'), 3589),
                pt(f.size) || g('Invalid type for parameter "size", expected normal|compact, got "'.concat(f.size, '" ').concat(F(f.size)), 3590),
                ct(f.theme) || g('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(f.theme, '" ').concat(F(f.theme)), 3591),
                ut(f.retry) || g('Invalid type for parameter "retry", expected never|auto, got "'.concat(f.retry, '" ').concat(F(f.retry)), 3592),
                f.language || (f.language = "auto"),
                gt(f.language) || (x('Invalid language value: "'.concat(f.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")),
                f.language = "auto"),
                yt(f.appearance) || g('Unknown appearance value: "'.concat(f.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                ht(f.execution) || g('Unknown execution value: "'.concat(f.execution, ", expected either: 'render' or 'execute'."), 3601),
                lt(f["retry-interval"]) || g('Invalid retry-interval value: "'.concat(f["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                st(f["expiry-interval"]) || g('Invalid expiry-interval value: "'.concat(f["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                var Re, Z = (Re = f["refresh-expired"]) !== null && Re !== void 0 ? Re : ee.Auto;
                vt(Z) ? f["refresh-expired"] = Z : g('Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'.concat(Z, '" ').concat(typeof Z == "undefined" ? "undefined" : F(Z)), 3603);
                var Se, oe = (Se = f["refresh-timeout"]) !== null && Se !== void 0 ? Se : ce.Auto;
                mt(Z) ? f["refresh-timeout"] = oe : g('Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'.concat(oe, '" ').concat(typeof oe == "undefined" ? "undefined" : F(oe)), 3603);
                var H = document.createElement("iframe")
                  , fe = document.createElement("div")
                  , Pt = fe.attachShadow({
                    mode: "closed"
                });
                dt(he) || g('Invalid input for optional parameter "action", got "'.concat(he, '"'), 3604),
                ft(re) || g('Invalid input for optional parameter "cData", got "'.concat(re, '"'), 3605);
                var Ae = l()
                  , pe = $(Ae);
                if (!(!Ae || !pe)) {
                    var Wt = []
                      , Ze = f.execution === me.Render;
                    Ze && Wt.push(ue.Execute),
                    y.lastWidgetIdx++;
                    var Sr = {};
                    ...
                    et || g("Turnstile Initialization Error ", 3606),
                    H.style.display = "none",
                    H.style.border = "none",
                    H.style.overflow = "hidden",
                    H.setAttribute("src", Rt(Ae, j, f, K, !1, "g", z.New, _t(et))),
                    H.onerror = function() {
                        if (Y) {
                    ...
                    ;
                    var Ut = ["cross-origin-isolated", "fullscreen", "autoplay"], tt;
                    L((tt = (u = document.featurePolicy) === null || u === void 0 || (r = u.features) === null || r === void 0 ? void 0 : r.call(u)) !== null && tt !== void 0 ? tt : [], Et) && Ut.push(Et),
                    H.setAttribute("allow", Ut.join("; ")),
                    H.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                    H.id = pe;
                    var rt;
                    H.tabIndex = (rt = f.tabindex) !== null && rt !== void 0 ? rt : 0,
                    ...
                    if (Ar) {
                        ...
                        Me.type = "hidden";
                        var nt;
                        if (Me.name = (nt = f["response-field-name"]) !== null && nt !== void 0 ? nt : xt,
                        Me.id = "".concat(pe, "_response"),
                        fe.appendChild(Me),
                        typeof f["response-field-name"] != "string" && Rr(j)) {
                            var Le = document.createElement("input");
                            Le.type = "hidden",
                            Le.name = bt,
                            Le.id = "".concat(pe, "_legacy_response"),
                            fe.appendChild(Le)
                        }
                    }
                    if (y.isRecaptchaCompatibilityMode) {
                        ...
                        Fe.type = "hidden",
                        Fe.name = wt,
                        Fe.id = "".concat(pe, "_g_response"),
                        fe.appendChild(Fe)
                    }
                    return m.appendChild(fe),
          ...
          , k = function() {
            ...
            return i === -1 && g("Could not find widget", 43778),
            n
        };
        function O() {
            return O = qt(function(b, n, i, r) {
                var u, d, m, w, E, S, I, D, U, X, J;
                return Pe(this, function(f) {
                    switch (f.label) {
                    case 0:
                        if (u = b.params.sitekey,
                        d = wr(),
                        !d)
                            return x("Cannot determine Turnstile's embedded location, aborting clearance redemption."),
                            a(b, n, !1),
                            [2];
                        m = "h/".concat("g", "/"),
                        w = new URL(d),
                        E = "https",
                        S = "",
                        D = "".concat(E, "://").concat(w.host, "/cdn-cgi/challenge-platform/").concat(m, "rc/").concat(r).concat(S),
                        f.label = 1;
                    case 1:
                    ...
                    case 2:
                        return U = f.sent(),
                        U.status === 200 ? [3, 3] : (x("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                        a(b, n, !1),
                        [3, 5]);
                    case 3:
                        return [4, U.json()];
                        ...
                        case "init":
                            {
                                ...
                                d || g("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === q.Invisible && r.params["refresh-expired"] === ee.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(ee.Auto, "' or '").concat(ee.Never, ".'")),
                                ...
                                m || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                        ...
                        case "reject":
                            {
                                ...
                                if (r.isExecuting = !1,
                                S || g("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3075),
                        ...
                        case "fail":
                            {
                                ...
                                if (D) {
                                    var f;
                                    D(String((f = n.code) !== null && f !== void 0 ? f : Qt)) ? r.params.retry === ve.Auto && !r.isResetting && t(r, i, U) : (n.code && x("Error: ".concat(n.code, ".")),
                                    t(r, i, U))
                                } else
                                    n.code ? (t(r, i, U),
                                    g("Error: ".concat(n.code), 3076)) : t(r, i, !1);
                                break
                            }
                        case "feedbackInit":
                            {
                        ...
                        case "requestFeedbackData":
                            {
                                ...
                                ke || g("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                        ...
                        case "turnstileResults":
                            {
                                ...
                                se || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                ...
                                _e || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                vr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                ...
                                r.params["refresh-expired"] === ee.Auto && !r.isResetting && _(z.AutoExpire, i);
                                break
                            }
                        case "interactiveTimeout":
                            {
                                ...
                                Nt(i);
                                var de = r.cbTimeout;
                                if (de ? de() : r.params["refresh-timeout"] === ce.Never && !r.isResetting && x("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."),
                                r.params["refresh-timeout"] === ce.Auto && !r.isResetting) {
                        ...
                        case "interactiveBegin":
                            {
                                ...
                                Ne || g("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                        ...
                        case "requestExtraParams":
                            {
                                ...
                                Y || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var Je = {}
                                  , Re = W()
                                  , Z = {
        ...
        return it(Ve({}, G), {
            ready: function(n) {
                if (y.scriptWasLoadedAsync && (x("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors."),
                g("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                typeof n != "function" && g('turnstile.ready() expected a "function" argument, got "'.concat(typeof n == "undefined" ? "undefined" : F(n), '"'), 3841),
                y.isReady) {
                    n();
                    return
                }
            ...
            execute: function(n, i) {
                ...
                if (!r) {
                    ...
                    var u = T(n, i);
                    u || g("Failed to render widget", 43522),
                    r = u
                }
                ...
                if (d) {
                    ...
                    d.response) {
                        var w;
                        d.isExecuting = !1,
                        x("Call to execute() on a widget that was already executed (".concat(m, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                        (w = d.cbSuccess) === null || w === void 0 || w.call(d, d.response, !1);
                        return
                    }
                    d.isExpired && x("Call to execute on a expired-widget (".concat(m, "), consider using reset() before.")),
                    d.isStale && (_(z.StaleExecute, m),
                    d.isExecuting = !0),
                    d.msgQueue.push(ue.Execute),
                    d.isExecuted = !0;
                    var E = d.shadow.querySelector("#".concat(m));
                    if (E || (d.isExecuting = !1,
                    g("Widget ".concat(m, " to execute was not found"), 43522)),
                    d.isResetting)
                        return;
                    if (d.isInitialized && h(d, r, E),
                    d.isInitialized && d.params.appearance === Q.Execute && Mt(E, d),
                    d.isExecuting) {
                        var S, I = d.shadow.querySelector("#".concat(m));
                        I || g("Received state for an unknown widget: ".concat(r), 3078),
                        (S = I.contentWindow) === null || S === void 0 || S.postMessage({
                            source: P,
                            widgetId: r,
                            event: "execute"
                        }, "*")
            ...
            getResponse: function(n) {
                ...
                if (typeof n == "undefined") {
                    ...
                    if (r) {
                        ...
                        return d != null && d.isExpired && x("Call to getResponse on a widget that expired, consider refreshing the widget."),
                        (u = y.widgetMap.get(r)) === null || u === void 0 ? void 0 : u.response
                    }
                    g("Could not find a widget", 43794)
                }
                var m = R(n);
                return m || g("Could not find widget for provided container", 43778),
                (i = y.widgetMap.get(m)) === null || i === void 0 ? void 0 : i.response
            },
    ...
    function qr(e) {
        ...
        if (l && (pt(l) ? a.size = l : x('Unknown data-size value: "'.concat(l, '".'))),
        0)
            var v;
        ...
        n ? ($t(n) || x('Invalid data-feedback-enabled value: "'.concat(n, ", expected either: 'true' or 'false'. Value is ignored.")),
        a["feedback-enabled"] = n === "true") : a["feedback-enabled"] = !0;
        ...
        return m && (yt(m) ? a.appearance = m : x('Unknown data-appearance value: "'.concat(m, ", expected either: 'always', 'execute', or 'interaction-only'."))),
        a
    }
    function zr() {
        var e = !0;
    ...
    ge = !1,
    C = pr(),
    y.scriptWasLoadedAsync = (Ye = C == null ? void 0 : C.loadedAsync) !== null && Ye !== void 0 ? Ye : !1,
    y.scriptUrl = (Qe = C == null ? void 0 : C.src) !== null && Qe !== void 0 ? Qe : "undefined",
    C != null && C.params && (ye = C.params.get("compat"),
    (ye == null ? void 0 : ye.toLowerCase()) === "recaptcha" ? window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled.") : (x("Compatibility layer enabled."),
    y.isRecaptchaCompatibilityMode = !0,
    window.grecaptcha = Dt) : ye !== null && x('Unknown value for api.js?compat: "'.concat(ye, '", ignoring.')),
    ...
    B && !ge && setTimeout(function() {
        typeof window[B] == "function" ? window[B]() : (x("Unable to find onload callback '".concat(B, "' immediately after loading, expected 'function', got '").concat(F(window[B]), "'.")),
        setTimeout(function() {
            typeof window[B] == "function" ? window[B]() : x("Unable to find onload callback '".concat(B, "' after 1 second, expected 'function', got '").concat(F(window[B]), "'."))
        }, 1e3))
    }, 0)),
    Lt = "turnstile"in window,
    Lt && !ge ? x("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Lt && ge && (_r(window.turnstile, y),
    Ot(y),
    (C == null || (Ke = C.params) === null || Ke === void 0 ? void 0 : Ke.get("render")) !== "explicit" && setTimeout(Ft, 0)),
    window.turnstile = Dt,
    ge || ((C == null || ($e = C.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit" && Vt.push(Ft),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(br, 0) : window.addEventListener("DOMContentLoaded", br))),
    Er = 24 * 60 * 60 * 1e3,
    window.setTimeout(zr, Er);
    var ge, C, Ye, Qe, ye, B, Lt, Ke, $e, Er;
}
)();
can this code be useful to prevent from blockage of page 20